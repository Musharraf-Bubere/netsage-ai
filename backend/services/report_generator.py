"""
NetSage AI - Forensic Report Generator
-------------------------------------------
...
def generate_pdf_report():
    ...
    document_elements.append(Paragraph('🛡️ NetSage AI: Forensic Investigation Report', text_styles['Title']))
...
def generate_docx_report():
    ...
    word_doc = Document()
    word_doc.add_heading('NetSage AI: Forensic Investigation Report', 0)
